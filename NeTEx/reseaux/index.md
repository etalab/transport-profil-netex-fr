...
|        | ***ImageUri***         | *xsd:anyURI*         | 0:1 | <p>URL d'accès à la carte schématique</p><p><mark>La carte schématique peut être aussi bien une image raster classique (.png, .jpg, etc.), qu'une image vectorielle (.svg, .ai, etc.).</mark> |
