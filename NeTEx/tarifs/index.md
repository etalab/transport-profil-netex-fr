...
|                    | ***ShortName***               | *xsd:normalizedString*                                   | 0:1             | Nom court de la zone visible par les voyageur (par exemple "1", "2", etc.). Il est recommandé de ne pas inclure le mot "Zone" (sauf choix de communication).                             |
|                    | ***Name***                    | *xsd:normalizedString*                                   | 1:1             | Nom de la zone tarifaire visible par le voyageur. Ce champ est rendu obligatoire dans tous les elements de type `GroupOfEntities` (cf. partie Elements Communs du profil France). Dans le cas où la zone tarifaire ne dispose que d'un nom court, il est recommandé de le diffuser dans les deux champs `ShortName` et `Name`. |
|                    | ***Descripotion***            | *xsd:normalizedString*                                   | 0:1             | Description textuelle de la zone.                                                                        |
